...
class PredictionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HealthCheck = channel.unary_unary(
                ...
                response_deserializer=prediction__pb2.HealthCheckResponse.FromString,
                _registered_method=True)
...
def add_PredictionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'HealthCheck': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=prediction__pb2.HealthCheckRequest.FromString,
                    response_serializer=prediction__pb2.HealthCheckResponse.SerializeToString,
            ),
    }
...
class PredictionService(object):
    ...
    def HealthCheck(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/prediction.PredictionService/HealthCheck',
            prediction__pb2.HealthCheckRequest.SerializeToString,
            prediction__pb2.HealthCheckResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
